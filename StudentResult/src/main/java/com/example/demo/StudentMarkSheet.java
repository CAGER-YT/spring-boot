...
public class StudentMarkSheet {
	...
	public int getSem11Practicals() {
		return sem11Practicals;
	}
	public void setSem11Practicals(int sem11Practicals) {
		this.sem11Practicals = sem11Practicals;
	}
